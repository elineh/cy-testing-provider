...
// 1) Run the provider(server) service
...
describe('Pact Verification', () => {
  ...
  // our produceMovieEvent has some concole.logs we don't need during tests
  // but you can comment these out if you don't want to see them
  beforeAll(() => {
