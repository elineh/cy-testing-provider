...
// Routes are focused on request handling and response formatting (handling HTTP reqs and res)
// delegating the business logic to the MoviesService (business layer) (Separation of Concerns)
